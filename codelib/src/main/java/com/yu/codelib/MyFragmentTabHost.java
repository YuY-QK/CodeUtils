...
/**
 * Created by ArmGlobe on 2016/9/21.
 * 重写系统的FragmentTabHost,采用hide和show的方式显示和隐藏fragment,避免fragment的重新创建
 */
public class MyFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    static final class TabInfo {
        ...
        TabInfo(String tag, Class<?> aClass, Bundle args) {
            this.tag = tag;
            clss = aClass;
            this.args = args;
        }
    ...
    public void addTab(TabSpec tabSpec, Class<?> clss, Bundle args) {
        ...
        if (mAttached) {
            // If we are already attached to the window, then orderCheck to make
